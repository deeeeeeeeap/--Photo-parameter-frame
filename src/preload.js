...
contextBridge.exposeInMainWorld('lensframe', {
    ...
    generateBlurPoster: (filePath, exifInfo, isPreview = false, exportQuality = 'high', logoScale = 1.0) =>
        ipcRenderer.invoke('generate-blur-poster', filePath, exifInfo, isPreview, exportQuality, logoScale),
